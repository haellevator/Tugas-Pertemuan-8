...
burgerBtn.addEventListener("click", ()=>{
    ...
    // jika navlinks class nya tidak aktif, maka tutup dropdownnya
    if(!navlinks.classList.containts("show")){
